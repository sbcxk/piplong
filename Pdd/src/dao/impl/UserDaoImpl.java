...
public class UserDaoImpl implements UserDao {
    ...
    public void update(User user) {
        String sql = "update user set password = ? , email = ? , status = ? where id = ?";
        template.update(sql, user.getPassword(),  user.getEmail(), user.getStatus(),user.getId());
    }
    ...
    @Override
    public boolean findHaveUserServlet(String username) {
        User user = null;
        try {
            //查询用户名
            String sql="select * from user where username = ?";
