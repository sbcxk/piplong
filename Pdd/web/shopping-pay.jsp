...
<div class="container">
    ...
    <div class="title-infor">
        <span class="number">交易号：20180827161648YXMPDD1609865559</span>
        <span class="infor-price">实付 :</span>
        <span class="money">￥159.00</span>
    </div>
    <div class="title-infor">
        <span class="number">收件人：PPL</span>
    </div>
    <div class="title-infor">
        <span class="number">联系方式：1433223</span>
    </div>
    <div class="title-infor">
        <span class="number">收货地址：吉首大学火焰山</span>
    </div>
