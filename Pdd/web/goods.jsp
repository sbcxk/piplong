...
<head>
    ...
    <script type="text/javascript">
        function subForm() {
            document.pay.action="${pageContext.request.contextPath}/buyServlet";
            document.pay.submit();
        }
    </script>
    <script>
        function joinCart() {
            //用户安全提示
            if (confirm("点击确定加入购物车")) {
                //访问路径
                <%--location.href = "${pageContext.request.contextPath}/index.jsp";--%>
                // document.getElementById("form1").submit();
                document.pay.action="${pageContext.request.contextPath}/CartItemServlet";
                document.pay.submit();
            }
        }
...
<div class="showall">
    ...
    <div class="tb-property">
        ...
        <div class="txt">
            ...
            <div class="cumulative">
                <span class="number ty1">累计售出<br/><em id="add_sell_num_363">999+</em></span>
        ...
        <form action="" id="form1" method="get" name="pay">
            <%--提交方法--%>
    ...
    <div class="extInfo">
        ...
        <div class="seller-pop-box">
            <span class="tr">商家名称：优购自营</span>
            <span class="tr">商家等级：VIP店铺</span>
