...
<c:forEach items="${list}" var="newPro" varStatus="idx">
    <c:if test="${(idx.index)%5==0}">
        <div class="col-md-1" style="text-align:center;height:200px;padding:10px 0px; margin-top: 50px;">&nbsp;</div>
    </c:if>
    <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;margin-top: 50px;">
